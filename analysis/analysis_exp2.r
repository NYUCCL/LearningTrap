...
questiondata = read.csv('../data/questiondata_exp2.csv')
...
pdf("../doc/journal/figures/exp2_mlm.pdf", height=10, width=8)
g
dev.off()
png("../doc/journal/figures/exp2_mlm.png", height=10, width=8,  units="in", res=200)
g
dev.off()
